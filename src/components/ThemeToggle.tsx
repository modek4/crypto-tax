...
export function ThemeToggle() {
  ...
  return (
    <button
      ...
      className="p-2 rounded-lg bg-gray-200 dark:bg-gray-900 text-gray-800 dark:text-gray-200 hover:bg-gray-300 dark:hover:bg-gray-700"
      aria-label="Dark Mode"
    >
        <span dangerouslySetInnerHTML={{ __html: isDark ? sunSVG : moonSVG }} />
    </button>
  );
}